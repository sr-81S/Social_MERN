...
const MyPostWidget = ({ picturePath }) => {
  ...
  //post handel to db function section
  ...
  return (
    <WidgetWrapper>
      ...
      <FlexBetween>
        ...
        {/* in mobile view the image is visible and other is not visible */}
        ...
        {isNonMobileScreens ? (
          ...
          // more option view on mobile screen mode
          <FlexBetween gap="0.25rem">
